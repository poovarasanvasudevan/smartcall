export const makeSipUri = (extension) => {
    return "sip:" + extension + "@asterisk.inditechman.com";
}

export const WSS_SERVER = "wss://asterisk.inditechman.com:8089/ws";
...
const CALL_API_BASE_URL = "https://vc-demo.ctsmartdesk.com/smartcall"

export const APIUrl = {
    GET_ACCESS_TOKEN: `${API_BASE_URL}/auth/v1/token`,
    ...
    END_USER_EXTENSION: `${CALL_API_BASE_URL}/v1/`
}